...
@SpringBootTest // test용 어플리케이션 컨텍스트
...
class BlogApiControllerTest {
    ...
    @DisplayName("addArticle : blog 글 추가")
    @Test
    ...
    @DisplayName("findAllArticle : blog 글 목록 조회")
    @Test
    ...
    @DisplayName("findArticle : blog 글 조회")
    @Test
    ...
    @DisplayName("deleteArticle : blog 글 삭제")
    @Test
    ...
    @DisplayName("updateArticle : blog 글 수정")
    @Test
